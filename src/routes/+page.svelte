<script type="text/javascript" charset="utf-8">
  import LinkRecurrence from '../recurrences/LinkRecurrence.svelte'
  import InfoRecurrence from '../recurrences/InfoRecurrence.svelte'
  import SuccessRecurrence from '../recurrences/SuccessRecurrence.svelte'
  import WarnRecurrence from '../recurrences/WarnRecurrence.svelte'
  import { CheckSquareIcon, ChevronsUpIcon} from 'svelte-feather-icons'
</script>
...
<main>
    ...
    <div class="mb-tbp2 mb-ls">
      <ul class="flex flex-col items-start gap-5" >
       <li class="flex text-sv items-center justify-center gap-5"> <CheckSquareIcon class="" size="40" /> <span>Pague até 30x menos do que o casual, e obtenha um site bem melhor do que os tradicionais</span></li>
        ...
        <li class="flex text-sv items-center justify-center gap-5"> <CheckSquareIcon class="" size="40"  /> <span> Pague parcelado para manutensão, não é necessário cartão de crédito.</span> <a href="inline"><LinkRecurrence><span>saiba mais</span></LinkRecurrence></a> </li>
         <li class="flex text-sv items-center justify-center gap-5"> <CheckSquareIcon class="" size="40"  /> <span>Programamos com ferramentas modernas e dinâmicas, velocidade na renderização é tudo. </span></li>
         <li class="flex text-sv items-center justify-center gap-5"> <CheckSquareIcon class="" size="40"  /> <span>Criamos diversos tipos de websites, adaptamos sua necessidade.</span> <a href="inline"><LinkRecurrence><span>catálogo</span></LinkRecurrence></a> </li>
      </ul>
    </div>
  </section>
  <section class="mt-ls p-ls mt-tbp2">
		...
		<iframe
            ...
            frameborder="0"
            allowfullscreen
            class="absolute rounded-b-xl top-0 left-0 w-full h-full"
        ></iframe>
	</div>
